...
python -m leankeeper update          # update incrémental (extract + index)
...
| Fichier | Rôle |
|---------|------|
| `__main__.py` | Point d'entrée CLI : sous-commandes `extract`, `stats`, `export`, `rag` |
...
| `extractors/lean.py` | Parse les déclarations Lean 4 du source (regex, ~215K decls) |
