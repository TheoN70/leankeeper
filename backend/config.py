...
# SQLite par défaut — pour PostgreSQL :
# DATABASE_URL = "postgresql://user:pass@localhost:5432/leankeeper"
DATABASE_URL = f"sqlite:///{DATA_DIR / 'leankeeper.db'}"

# ──────────────────────────────────────────────
# GitHub
# ──────────────────────────────────────────────

GITHUB_TOKEN = ""  # gh token avec permissions repo:read
...
ZULIP_EMAIL = ""  # Email du compte Zulip
ZULIP_API_KEY = ""  # Clé API Zulip (Settings > Your bots)
