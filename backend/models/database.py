...
Utilise SQLAlchemy avec SQLite par défaut.
Pour passer à PostgreSQL : changer DATABASE_URL dans config.py.
"""
...
def init_db(database_url: str = "sqlite:///leankeeper.db") -> sessionmaker:
